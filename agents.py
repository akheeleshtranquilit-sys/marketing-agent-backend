...
# ----------------------------------------------------
# GLOBAL MARKETING GUIDELINES (unchanged)
# ----------------------------------------------------
GLOBAL_GUIDELINES = [
...
# ----------------------------------------------------
# OPTIONAL WEB SEARCH HOOK (NO API required)
# ----------------------------------------------------
def web_search(query):
    """
    Placeholder for real competitor research.
    Currently returns mock data, but you can integrate:
    - Google Custom Search API
    - SERPAPI
    - RapidAPI search endpoints
    """
    return [
        f"Latest info about {query} (real data requires API integration)."
    ]
...
class CompetitorAnalysisAgent:
    ...
    def advanced_analysis(self):
        return {
            "swot": {
                ...
                "Competitor B": {
                    "strengths": ["Cheap", "Large customer base"],
    ...
    def web_research_analysis(self, objective):
        search_results = web_search(objective)
        return {
...
# ----------------------------------------------------
# SUPERVISOR (NOW UPDATED TO INCLUDE COMPETITOR ANALYSIS)
# ----------------------------------------------------
class Supervisor:
    def __init__(self):
